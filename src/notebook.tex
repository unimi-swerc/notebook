...
\node[coordinate, shift={(0cm, 0cm)}, anchor=north west](NW2) at (NW.south west) {};
\node[coordinate, shift={(0cm, 0cm)}, anchor=north west](NW3) at (NW.north east) {};
\node[coordinate, shift={(-0.05cm, 0cm)}, anchor=west](W)        at (Text.west) {};
\node[shift={(0cm, -0.6cm)}, anchor=south west](SW) at (Text.south west) {\pgfornament[width=1.75cm,symmetry=h]{37}};
\node[coordinate, shift={(0cm, 0cm)}, anchor=south west](SW2) at (SW.north west) {};
\node[coordinate, shift={(0cm, 0cm)}, anchor=south west](SW3) at (SW.south east) {};

\node[shift={(0.4cm, -0.1cm)}, anchor=north east](NE) at (Text.north east) {\pgfornament[width=1.75cm]{38}};
\node[coordinate, shift={(0.4cm, 0cm)}, anchor=north east](NE2) at (NE.south east) {};
\node[coordinate, shift={(0.0cm, 0cm)}, anchor=north east](NE3) at (NE.north west) {};
\node[coordinate, shift={(0.1cm, 0cm)}, anchor=east](E)        at (Text.east) {};
\node[shift={(0.4cm, -0.6cm)}, anchor=south east](SE) at (Text.south east) {\pgfornament[width=1.75cm,symmetry=h]{38}};
\node[coordinate, shift={(0.4cm, 0cm)}, anchor=south east](SE2) at (SE.north east) {};
\node[coordinate, shift={(0.0cm, 0cm)}, anchor=south east](SE3) at (SE.south west) {};

\pgfornamenthline{NW3}{NE3}{north}{85}
    ...
    if not section:find("%.") then
        ...
        for _, subsection in ls(section_dir) do
            ...
            if not subsection:find("%.") then
                ...
                tex.print("\\subsection{" .. subsection:gsub("^%l", string.upper) .. "}" .. "\\vspace{-0.20em}")
