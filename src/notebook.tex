...
\renewcommand*{\addcontentsline}[4]{\addtocontents{toc}{\protect\contentsline{#2}{#3}{}{#4}}} % toc entries without page number
...
\addtocontents{toc}{\vspace{-2em}\setlength{\columnsep}{-0.5cm}\protect\begin{multicols}{2}}
{\fontsize{8}{8.5}\selectfont \tableofcontents}
\vspace{-5.1em}
\begin{luacode*}
    ...
    if not section:find("%.") then
        ...
        for _, subsection in ls(section_dir) do
            ...
            if subsection:find("%.cpp$") then
                tex.print("\\subsection{" .. subsection_name .. "}" .. "\\vspace{-0.87em}")
            ...
            if not subsection:find("%.") then
                ...
                tex.print("\\subsection{" .. subsection:gsub("^%l", string.upper) .. "}" .. "\\vspace{-0.87em}")
                for _, subsubsection in ls(subsection_dir) do
                    ...
                    if subsubsection:find("%.cpp$") then
                        tex.print("\\subsubsection{" .. subsubsection_name .. "}" .. "\\vspace{-0.87em}")
