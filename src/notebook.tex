...
\node[text width=9.3cm,align=center](Text){{\fontsize{8pt}{8pt} \selectfont \tableofcontents}};
...
local sectionOrnamentSizes = {4, 4, 5.7, 3.2, 2.7, 4.5, 6.5}
local sectionOrnamentOffsetx = {-1, 3, 3, 2, 2, 2, 5}
local sectionOrnamentOffsety = {1, 10, 8, -2, -1, 12, 12}
