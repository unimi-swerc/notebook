...
\node[coordinate, shift={(0cm, 0.05cm)}, anchor=north west](NW3) at (NW.north east) {};
...
\node[coordinate, shift={(0cm, -0.05cm)}, anchor=south west](SW3) at (SW.south east) {};
...
\node[coordinate, shift={(0.0cm, 0.05cm)}, anchor=north east](NE3) at (NE.north west) {};
...
\node[coordinate, shift={(0.0cm, -0.05cm)}, anchor=south east](SE3) at (SE.south west) {};
