...
\node[shift={(0cm, -0.1cm)}, anchor=north west](NW2) at (NW.south west) {};
\node[minimum height = 0cm, shift={(-0.05cm, 0cm)}, anchor=west](W)        at (Text.west) {};
\node[shift={(0cm, -0.6cm)}, anchor=south west](SW) at (Text.south west) {\pgfornament[width=1.75cm,symmetry=h]{37}};
\node[shift={(0cm, -0.6cm)}, anchor=south west](SW2) at (SW.north west) {};

\node[shift={(0.4cm, -0.1cm)}, anchor=north east](NE) at (Text.north east) {\pgfornament[width=1.75cm]{38}};
\node[shift={(0.4cm, 0cm)}, anchor=north east](NE2) at (NE.south east) {};
\node[minimum height=0cm, shift={(0.1cm, 0cm)}, anchor=east](E)        at (Text.east) {};
\node[shift={(0.4cm, -0.6cm)}, anchor=south east](SE) at (Text.south east) {\pgfornament[width=1.75cm,symmetry=h]{38}};
\node[shift={(0.4cm, 0cm)}, anchor=south east](SE2) at (SE.north east) {};
