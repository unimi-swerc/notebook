...
\newcommand{\maketeampage}{
	...
	\begin{center}
		\strut % Magic
		\vspace{3cm}\\
		\includegraphics[width=5cm]{unimi.png}\\
		{\fontsize{25}{30}\selectfont Università degli Studi di Milano\\}
		{\fontsize{60}{60}\selectfont LaStatale Blue\\}
		\vspace{0.5cm}
		{\huge Nicolas Albani, Alessandro Bortolin, Fabrizio Brioni\\}
		\vfill
		{\fontsize{21}{25}\selectfont Southwestern Europe Regional Contest 2023-2024}\\
		\vspace{0.5cm}
		{\huge 28 Gennaio 2024}\\
		\vspace{1cm}
	\end{center}
	\clearpage
	\pagestyle{fancy}
