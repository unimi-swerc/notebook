...
Numero di permutazioni di $n$ elementi con $k$ cicli. I punti fissi sono considerati come cicli lunghi 1.
...
\# di permutazioni di $n$ elementi senza punti fissi: $$ D(n)=nD(n-1)+(-1)^n $$
